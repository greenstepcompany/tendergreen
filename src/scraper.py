...
KLJUCNE_RIJECI = [
    "zelene površine", "hortikultura", "košenje trave",
    "sadnja bilja", "uređenje dvorišta", "uređenje parka",
    "travnjak", "zelenilo", "pejzažno uređenje",
    "drveće", "grmlje", "cvjetne površine",
    "zeleni pojas", "vrtlarstvo", "hortikulturno",
    "parkovi", "sadni materijal",
]
